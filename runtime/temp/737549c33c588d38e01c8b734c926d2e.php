<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\index\login.html";i:1520852597;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form method="post" action="" class="form-inline">
        <div>
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="class_name" placeholder="一年级172班">
            </div>
        </div>
        <br>
        <div>
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="student_name" placeholder="张三">
            </div>
        </div>
        <br>
        <div class="input-group">
...
//给登录按钮添加点击事件
        $("#login").on('click', function (event) {
            $.ajax({
                ...
                success: function () {          //只有标志位返回为1时才进行处理
