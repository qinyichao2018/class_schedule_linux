<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\user\student_login.html";i:1521906607;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//给登录按钮添加点击事件
        $("#login").on('click', function (event) {
            $.ajax({
                type: "POST",
                url: "<?php echo url('check_student_login'); ?>",  //设置提交数据处理的脚本文件的地址；
