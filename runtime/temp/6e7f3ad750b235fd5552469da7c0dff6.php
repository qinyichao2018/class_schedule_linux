<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\user\teacher_register.html";i:1521098372;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div align="center">
    ...
    <form method="post" action="" class="form-inline">
        ...
        <div>
            <div class="input-group">
                <span class="input-group-addon">班主任<input type="checkbox" id="checkbox" name="checkbox"
                                                          value="1"></span>
                <input class="form-control" type="text" id="head_teacher" name="head_teacher" value=""
                       placeholder="不勾选为非班主任" disabled>
            </div>
        </div>
        <br>
        <div>
        ...
        <div>
            <div class="horizontal">
                ...
                <br>
                <input id="register" class="btn btn-success" type="button" value="注&nbsp;册">
            </div>
        </div>
</div>
</form>
...
//给注册按钮添加点击事件
        $("#register").on('click', function (event) {
            $.ajax({
                type: "POST",
                url: "<?php echo url('check_teacher_register'); ?>",  //设置提交数据处理的脚本文件的地址；
                ...
                success: function (data) {          //只有标志位返回为1时才进行处理
                    ...
                    if (data.status == 1) {
                        ...
                        window.location.href = "<?php echo url('user/teacher_index'); ?>"; //允许用户进入后台
                    } else {
