<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\user\student_register.html";i:1521906607;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//给登录按钮添加点击事件
        $("#register").on('click', function (event) {
            $.ajax({
                type: "POST",
                url: "<?php echo url('check_student_register'); ?>",  //设置提交数据处理的脚本文件的地址；
                ...
                success: function (data) {          //只有标志位返回为1时才进行处理
                    ...
                    if (data.status == 1) {
                        ...
                        window.location.href = "<?php echo url('user/student_index'); ?>"; //允许用户进入后台
                    } else {
