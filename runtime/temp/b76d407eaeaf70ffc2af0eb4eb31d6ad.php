<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\user\student_index.html";i:1522158074;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<ul class="nav nav-pills">
    <li><a href="<?php echo url('index/square'); ?>">广场</a></li>
    <li><a href="<?php echo url('index/download'); ?>">下载</a></li>
    <li><a href="<?php echo url('index/questionAnswer'); ?>">问答</a></li>
</ul>
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            <li class="dropdown-header header-nav-current-user css-truncate">
                <strong class="css-truncate-target"> 学生登录<p style="color: gold"><?php echo session('user_info.student_name'); ?></p>
                </strong>
            </li>
            <li class="divider"></li> <!--分割线-->
            <li><a href="<?php echo url('student_personal_info'); ?>">个人信息</a></li>
            <li><a href="<?php echo url('edit_sche',array('if_default'=>'yes')); ?>">编辑课表</a></li>
            <li><a href="<?php echo url('schedule_list'); ?>">我的课表</a></li>
            <li><a onclick="schedule_check(this,'<?php echo $schedule_check; ?>')" href="javascript:;">创建新课表</a></li>
            <li class="divider"></li> <!--分割线-->
...
<form method="post" action="">
    <div class="col-xs-4">
        <div class="input-group">
            <input name="text" class="form-control" type="text" placeholder="学校-班级 或者只输入班级、学校">
            <span class="input-group-btn">
            <button class="btn btn-default" id="searchSchedule" type="button">查找课表</button>
        </span>
        </div>
    </div>
</form>
...
<script>
    $(function () {
        $('#searchSchedule').on('click', function (event) {
            $.ajax({
                type: "POST",
                url: "<?php echo url('index/search_check'); ?>",
                data: $('form').serialize(),
                dataType: 'json',
...
<script>
    function schedule_check(obj,schedule_check) {
        if (schedule_check == 'yes') {
            window.location.href = "<?php echo url('new_schedule'); ?>";
        }
        if(schedule_check == 'no') {
            alert('创建课表数量超过上限，请删除部分课表后操作');
        }
    }
</script>
</html>