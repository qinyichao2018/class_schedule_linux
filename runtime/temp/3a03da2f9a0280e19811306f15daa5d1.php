<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\user\user_index.html";i:1520936767;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="btn-group">
        <button type="button" class="btn-xs btn-info dropdown-toggle" data-toggle="dropdown">
            <img alt="@<?php echo session('user_info.student_name'); ?>" class="avatar float-left mr-1"
                 src="/image/student_default.jpg" height="20" width="20">
            <span class="caret"></span>
        </button>
        <ul class="dropdown-menu" role="menu">
            <li class="dropdown-header header-nav-current-user css-truncate">
                <strong class="css-truncate-target"><?php echo session('user_info.student_name'); ?></strong>
            </li>
...
<table class="table table-bordered">
    ...
    <tr class="success">
        <td>1</td>
        <td><?php echo (isset($mon['section_1']) && ($mon['section_1'] !== '')?$mon['section_1']:''); ?><a href="<?php echo url('note_student_list',array('id'=>1)); ?>">查看笔记</a></td>
        <td><?php echo (isset($tue['section_1']) && ($tue['section_1'] !== '')?$tue['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
        <td><?php echo (isset($wed['section_1']) && ($wed['section_1'] !== '')?$wed['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
        <td><?php echo (isset($thu['section_1']) && ($thu['section_1'] !== '')?$thu['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
        <td><?php echo (isset($fri['section_1']) && ($fri['section_1'] !== '')?$fri['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
        <td><?php echo (isset($sat['section_1']) && ($sat['section_1'] !== '')?$sat['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
        <td><?php echo (isset($sun['section_1']) && ($sun['section_1'] !== '')?$sun['section_1']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
    </tr>
    <tr class="info">
        <td>2</td>
        <td><?php echo (isset($mon['section_2']) && ($mon['section_2'] !== '')?$mon['section_2']:''); ?><a href="<?php echo url('note_student_list'); ?>">查看笔记</a></td>
