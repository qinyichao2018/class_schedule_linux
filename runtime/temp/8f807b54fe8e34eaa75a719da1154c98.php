<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\class_schedule\public/../application/index\view\index\index.html";i:1522069688;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<ul class="nav nav-pills">
    ...
    <li>
        <ul class="nav nav-tabs">
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">注册
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo url('user/student_register'); ?>">学生注册</a></li>
                    <li><a href="<?php echo url('user/teacher_register'); ?>">教师注册</a></li>
                </ul>
            </li>
            <li>
        </ul>
        ...
        <ul class="nav nav-tabs">
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">登录
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="<?php echo url('user/student_login'); ?>">学生登录</a></li>
                    <li><a href="<?php echo url('user/teacher_login'); ?>">教师登录</a></li>
                </ul>
            </li>
            <li>
        </ul>
